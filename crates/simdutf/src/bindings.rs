...
extern "C" {
    ...
    pub fn simdutf_convert_latin1_to_utf8_with_errors(src: *const u8, len: usize, dst: *mut u8) -> Result;
    pub fn simdutf_convert_latin1_to_utf16_with_errors(src: *const u8, len: usize, dst: *mut u16) -> Result;
    pub fn simdutf_convert_latin1_to_utf16be_with_errors(src: *const u8, len: usize, dst: *mut u16) -> Result;
    pub fn simdutf_convert_latin1_to_utf16le_with_errors(src: *const u8, len: usize, dst: *mut u16) -> Result;
    pub fn simdutf_convert_latin1_to_utf32_with_errors(src: *const u8, len: usize, dst: *mut u32) -> Result;
